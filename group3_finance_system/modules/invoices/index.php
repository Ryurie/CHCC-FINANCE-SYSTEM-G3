        ...
        <div class="table-card">
            <table>
                ...
                <tbody>
                    ...
                    } else { echo "<tr><td colspan='8' class='empty-state' style='color:var(--text-secondary);'>No invoices have been recorded.</td></tr>"; }
                    ?>
                </tbody>
            </table>
        </div>
            ...
            <form method="POST" action="">
                ...
                <select id="student_id" name="student_id" required onchange="autoSelectDept()">
                    ...
                    if ($students_list && $students_list->num_rows > 0) {
                        ...
                        echo "<option value='' disabled>No students are enrolled.</option>";
                    }
                    ?>
                </select>
