        ...
        <div class="table-card">
            <table>
                ...
                <tbody>
                    ...
                    } else { echo "<tr><td colspan='7' class='empty-state' style='color:var(--text-secondary);'>Walang na-record na bayad.</td></tr>"; }
                    ?>
                </tbody>
            </table>
        </div>
        ...
        <div class="modal-box">
            ...
            <form method="POST" action="">
                ...
                <select id="invoice_id" name="invoice_id" required>
                    ...
                    } else { echo "<option value='' disabled>Walang pending na invoices.</option>"; }
                    ?>
                </select>
