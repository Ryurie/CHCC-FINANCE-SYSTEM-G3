        ...
        <div class="table-card animate-fade-up delay-1">
            ...
            <table>
                ...
                <tbody>
                    ...
                    } else { echo "<tr><td colspan='6' class='empty-state' style='text-align:center; padding: 40px; color:var(--text-secondary);'>Walang pumasok na pera sa mga petsang ito.</td></tr>"; }
                    ?>
                </tbody>
            </table>
        </div>
